...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform lg:static lg:inset-auto lg:translate-x-0 lg:transform-none transition-transform duration-300 ease-in-out ${
